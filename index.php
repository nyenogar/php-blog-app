      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
          <div class="box-wrap">
            <div class="box-wrap-grid">
              ...
              <div class="info">
                <h4><a href="#url"><?php echo $row['username']  ?></a></h4>
              </div>
            </div>
            <p class="mt-3"><?php echo substr($row['content'], 0, 80) . "..";  ?>.</p>
          </div>
        </div>
  ...
  <footer class="footer-28 position-relative py-5">
    <div class="container py-lg-3">
      ...
      <div class="midd-footer-28 align-center py-4 mt-5">
        <p class="copy-footer-28 text-center"> &copy; 2012 - <?php echo date("Y")  ?> Sectoral. All Rights Reserved. Design by <a
